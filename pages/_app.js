...
const NAV_LINKS = FOOTER_LINKS.filter((link) => link.href !== "/contact");
      ...
      >
        <div className="site-nav__inner">
          ...
          <nav className="site-nav__links" aria-label="Main navigation">
            ...
            <Link href="/contact" className="site-nav__cta btn btn--dark">
              Start a project
            </Link>
          </nav>
      ...
      <footer className="site-footer">
        <div className="site-footer__inner">
          <div className="site-footer__top">
            <Link href="/" className="site-footer__logo" aria-label="Nextale home">
              <Image src={logo} alt="Nextale" className="site-footer__logo-img" />
            </Link>
            <p className="site-footer__tagline">From Paper to Pixel</p>
          </div>
